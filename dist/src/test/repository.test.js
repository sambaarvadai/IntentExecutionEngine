...
const repository_1 = require("../graph/store/repository");
...
describe('GraphRepository', () => {
    ...
    async function createFreshRepository() {
        ...
        mockDb = await (0, sqlite_1.open)({
            filename: ':memory:',
            driver: sqlite3_1.default.Database
        });
        // Mock the getGraphDatabase function to return our in-memory database
        db_1.getGraphDatabase.mockResolvedValue(mockDb);
        // Create a new GraphRepository instance
        const repo = new repository_1.GraphRepository();
        return repo;
    }
    // Helper to create test graph data
    function createTestGraph(overrides = {}) {
        const testNode = {
            id: 'test-node-1',
            type: 'query',
