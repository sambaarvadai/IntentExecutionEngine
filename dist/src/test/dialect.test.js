...
const sqlite_1 = require("../execution/compiler/dialects/sqlite");
const postgres_1 = require("../execution/compiler/dialects/postgres");
const mysql_1 = require("../execution/compiler/dialects/mysql");
const compile_1 = require("../execution/compile");
describe('SQLiteDialect', () => {
    const dialect = new sqlite_1.SQLiteDialect();
...
describe('PostgresDialect', () => {
    const dialect = new postgres_1.PostgresDialect();
    it('quotes identifiers correctly', () => {
        expect(dialect.quoteIdentifier('name')).toBe('"name"');
        expect(dialect.quoteIdentifier('customers.name')).toBe('"customers"."name"');
    });
...
describe('MySQLDialect', () => {
    const dialect = new mysql_1.MySQLDialect();
...
describe('compileQuery dialect integration', () => {
    ...
    it('compiles with SQLite dialect', () => {
        ...
        const result = (0, compile_1.compileQuery)(plan, dialect);
    ...
    it('uses SQLite dialect by default', () => {
        const result = (0, compile_1.compileQuery)(plan); // No dialect parameter
