...
exports.routers = exports.apiRouter = exports.createRouter = exports.graphRouter = exports.stripFields = exports.filterResponse = exports.auditLog = exports.AuditLog = exports.rateLimiter = exports.RateLimiter = exports.sanitiseParams = exports.sanitiseArray = exports.sanitiseBoolean = exports.sanitiseNumber = exports.sanitiseString = exports.APIGenerator = exports.planHydrator = exports.PlanHydrator = exports.apiHandler = exports.APIHandler = exports.apiRegistry = exports.APIRegistryManager = void 0;
...
Object.defineProperty(exports, "apiRouter", { enumerable: true, get: function () { return apis_1.apiRouter; } });
// ------------------------------------------------------------------
// Route Registration
// ------------------------------------------------------------------
const graphs_2 = require("./routes/graphs");
const apis_2 = require("./routes/apis");
// Export all registered routers for easy access
exports.routers = {
    graphs: graphs_2.graphRouter,
    apis: apis_2.apiRouter,
};
...
function registerRoutes(app) {
    ...
    if (app.use && typeof app.use === 'function') {
        ...
        app.use('/api', (req, res, next) => {
            ...
            for (const [routeKey, { handler }] of apis_2.apiRouter.routes) {
                // Split on the first colon only to handle paths with :params
                const colonIndex = routeKey.indexOf(':');
                const routeMethod = routeKey.substring(0, colonIndex);
                const routePath = routeKey.substring(colonIndex + 1);
