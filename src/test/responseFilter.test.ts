...
import { filterResponse, stripFields } from '../api/responseFilter'
...
describe('Response Filtering', () => {
  ...
  describe('filterResponse', () => {
    it('public label returns data unchanged for any role', () => {
      const result = filterResponse(sampleData, {
        label: 'public',
        userRoles: ['guest']
      })
  ...
  describe('stripFields', () => {
    it('strips fields from rows in { rows: [...] } shape', () => {
      ...
      const result = stripFields(data, ['salary'])
    ...
    it('does not mutate original data', () => {
      ...
      stripFields(originalData, ['salary'])
